...
if (!empty($listaChequeoItems)) {
    foreach ($listaChequeoItems as $item) {
        ...
        $lista .= "<td><a href='documentos/archivos/certificado/{$item->getSsst()}' target='_blank' title='Ver certificado SSST'><button type='button' class='btn btn-outline-danger'><img src='layout/img/PDF2.png' alt='PDF' style='width:20px; height:20px;'></button></a></td>";
        $lista .= "<td><a href='documentos/archivos/arl/{$item->getArl()}' target='_blank' title='Ver certificado de ARL'><button type='button' class='btn btn-outline-danger'><img src='layout/img/PDF2.png' alt='PDF' style='width:20px; height:20px;'></button></a></td>";
